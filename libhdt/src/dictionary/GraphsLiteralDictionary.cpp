...
void GraphsLiteralDictionary::importFourthSection(Dictionary *other, IntermediateListener& iListener)
{
...
uint64_t GraphsLiteralDictionary::size()
{return BaseLiteralDictionary::size() + graphs->getSize();}


unsigned int GraphsLiteralDictionary::getMaxID()
{return BaseLiteralDictionary::getMaxID() + graphs->getLength();}

size_t GraphsLiteralDictionary::getNumberOfElements() {
